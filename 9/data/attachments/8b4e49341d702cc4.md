...
- Name: checkout-advanced.spec.ts >> Checkout advanced flows >> should place a COD order with a separate shipping address
- Location: tests/checkout-advanced.spec.ts:12:7
