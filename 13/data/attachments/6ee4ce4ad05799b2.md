...
- Name: checkout-advanced.spec.ts >> Checkout advanced flows >> should surface create-account checkout schema error until GENKI-BUG-002 is fixed
- Location: tests/checkout-advanced.spec.ts:45:7
