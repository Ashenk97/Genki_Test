...
- Name: checkout.spec.ts >> Checkout >> PayHere card payments >> should place a successful Visa card order via PayHere sandbox
- Location: tests/checkout.spec.ts:137:9
