...
- Name: checkout-advanced.spec.ts >> Gift checkout >> should disable COD for gift orders while keeping card and bank available
- Location: tests/checkout-advanced.spec.ts:68:7
