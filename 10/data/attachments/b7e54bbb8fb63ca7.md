...
- Name: checkout-advanced.spec.ts >> Gift checkout >> should clear a selected COD payment when the order is marked as a gift
- Location: tests/checkout-advanced.spec.ts:87:7
